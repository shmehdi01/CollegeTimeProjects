 ...
 * @author rizwan
 */
public class PwdPop extends javax.swing.JFrame {

    /**
     * Creates new form PwdPop
     */
    public PwdPop() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (pf.getText().equalsIgnoreCase("rizzCalc")) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PwdPop.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
